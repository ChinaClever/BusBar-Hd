...
public class HashSlaveCom {
    ...
    public void saveHashIntData(DevDataBase ptr, int len, List<Byte> data, int sizeBit){
        int[] buf = mIntArray;
     ...
     * @param data
     */
    private void saveString(DevStrBase strBase, int len, List<Byte> data) {
     ...
     * @param data
     */
    public void devStrSave(DevStrBase strBase, NetDataDomain data) {
