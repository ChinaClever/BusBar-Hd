package com.clever.www.busbar.net.data.recv;

import android.util.Log;

import com.clever.www.busbar.net.data.datadone.NetAnalyzeData;
import com.clever.www.busbar.net.data.packages.NetDataPacket;
import com.clever.www.busbar.dp.data.hash.slave.DevHashDataSlave;
...
public class NetDataReadThread implements Runnable{
    private NetDataList mDataList = NetDataList.bulid();
    private NetAnalyzeData mAnalyzeData = new NetAnalyzeData();
    private DevHashDataSlave mDataSlave = new DevHashDataSlave();
