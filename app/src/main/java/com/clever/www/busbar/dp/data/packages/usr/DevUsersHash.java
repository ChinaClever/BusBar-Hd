package com.clever.www.busbar.dp.data.packages.usr;
...
public class DevUsersHash {
    private Map<String, DevUsr> mHash = new HashMap<>();
     ...
     * @return
     */
    public DevUsr get(String name) { return mHash.get(name); }
     ...
     * @param from
     */
    public void setUsr(DevUsr usr, DevUsr from) {
